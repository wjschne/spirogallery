...
.column[
  <object id="suspensionofdisbelief" class="spiro" data="suspension_of_disbelief.svg" type="image/svg+xml"></object>
    
    <!--  --> 
    <button type="button" class="playbtn btn btn-light position-absolute bottom-0 start-0 m-2" onclick='playpause("suspensionofdisbelief", this);'>Play</button>
    <!--  --> 
...
.column[
  <object id="violetblackout" class="spiro" data="violet_blackout.svg" type="image/svg+xml"></object>
    
    <!--  --> 
    <button type="button" style="background-color:black" class="playbtn btn btn-dark position-absolute bottom-0 start-0 m-2" onclick='playpause("violetblackout", this);'>Play</button>
    !--  --> 
...
.column.bg-white[
  <object id="illusively" class="spiro" data="illusively_elusive_allusion.svg" type="image/svg+xml"></object>
    
    <!--  --> 
    <button type="button" class="playbtn btn btn-light position-absolute bottom-0 start-0 m-2" onclick='playpause("illusively", this);'>Play</button>
    <!--  --> 
]
...
.column.p-2.light[
  <object id="counterspintriangles" class="spiro" data="counterspin_triangles.svg" type="image/svg+xml"></object>
    
    <!--  --> 
    <button type="button" class="playbtn btn btn-light position-absolute bottom-0 start-0 m-2" onclick='playpause("counterspintriangles", this);'>Play</button>
    <!--  --> 
...
.column.p-2.dark[
  .vmiddle.center[
    # Remembering
    # .small[.small[the]] Merger .small[.small[of]] 
    # Reemerging
    # Memories
...
spiro(3,1,0.5,
      ...
      color_groups = 3,
      transparency = 0.5,
      colors = c("#000000", bg_light, "#8f0a7f"),
      points_per_polygon = 100) %>%
  image_merge(
    copies = k,
    output = "counterspin_triangles.svg") %>%
  image_scale(scale = seq(1, 0.1, length.out = k)) %>%
  image_spin(rpm = 3 * rep(c(1, -1), k / 2) * seq(1, 3, length.out = k)) %>%
  add_background(rounding = 1, color = bg_dark) %>% 
  pause_onload()
```
...
.column.p-2[
  <object id="secondeventhorizon" class="spiro" data="second_event_horizon.svg" type="image/svg+xml"></object>
    
    <!--  --> 
    <button type="button" class="playbtn btn btn-dark position-absolute bottom-0 start-0 m-2" onclick='playpause("secondeventhorizon", this);'>Play</button>
    <!--  --> 
...
.column[
  <object id="reconciliation491" class="spiro" data="reconciliation491.svg" type="image/svg+xml"></object>
    
    <!--  --> 
    <button type="button" class="playbtn btn btn-dark position-absolute bottom-0 start-0 m-2" style="background-color: #000526;" onclick='playpause("reconciliation491", this);'Play</button>
    <!--  --> 
]
...
.column.p-2.dark[
  <object id="webwindows" class="spiro" data="web_windows.svg" type="image/svg+xml"></object>
    
    <!--  --> 
    <button type="button" class="playbtn btn btn-dark position-absolute bottom-0 start-0 m-2" onclick='playpause("webwindows", this);'>Play</button>
    <!--  --> 
]
...
.column[
  <object id="collidingscopes" class="spiro" data="colliding_scopes.svg" type="image/svg+xml"></object>
    
    <!--  --> 
    <button type="button" class="playbtn btn btn-light position-absolute bottom-0 start-0 m-2" onclick='playpause("collidingscopes", this);'>Play</button>
    <!--  --> 
]
...
---
  class: split-square2
.fixed-bottom.left.p-4.gray[Inscribed polygons adapted from [Mathologer's T-Shirt](https://www.youtube.com/watch?v=qhbuKbxJsk8)]
...
.column[
  <!--  --> 
    <img src="superhero_bg.svg" type="image/svg+xml">
    <!--  --> 
]
...
.column[
  <object id="sunrisesaresunsetsrecycled" class="spiro" data="sunrises_are_sunsets_recycled.svg" type="image/svg+xml"></object>
    
    <!--  --> 
    <button type="button" class="playbtn btn btn-dark position-absolute bottom-0 start-0 m-2" onclick='playpause("sunrisesaresunsetsrecycled", this);'>Play</button>
    <!--  -->
]
...
.column[
  <object id="oneminutereunion" class="spiro" data="one_minute_reunion.svg" type="image/svg+xml"></object>
    
    <!--  --> 
    <button type="button" class="playbtn btn btn-light position-absolute bottom-0 start-0 m-2" onclick='playpause("oneminutereunion", this);'>Play</button>
    <!--  -->
]
